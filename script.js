...
const DAYS = [
  ...
  { id:"ven1", short:"Ven", num:"1", month:"Maggio", fullName:"Venerdì 1° Maggio", events:[
    {time:"11.00", icon:"church", title:"Visita guidata alla Chiesa Arcipretale di Pieve Cesato", subtitle:"Guidata dall'Arciprete Don Claudio", link:"https://www.parrocchiapievecesato.it/"},
    ...
    {time:"Pomeriggio", icon:"kids", title:"BUSKERS, ANIMAZIONI, GIOCOLERIA, TRUCCABIMBI — LAURA e i giochi di HAPPY FAMILY", link:"/angolo-dei-bambini.html"},
    ...
    {time:"22.45", icon:"dj", title:"DJ SET con GAO DJ", link:"simple-events/gao-dj.html"}
  ]},
